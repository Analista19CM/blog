...
$con = mysqli_connect("127.0.0.1", "root", "", "blog_cm"); //CONEXION SERVIDOR
...
$consulta= "SELECT usuario, clave, n_completo  FROM usuarios WHERE usuario='".$usuario."' and clave='".$password."'"; 
