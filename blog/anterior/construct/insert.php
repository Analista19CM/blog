...
try {
    ...
    $sql = "INSERT INTO entradas (titulo, descripcion_c, keywords, categoria, ciudad, n_fija, long_desc, imagen_fd, imagen_fi, imagen_fl, fecha)
    VALUES('".$titulo."','".$descripcion_c."','".$keywords."','".$categoria."','".$ciudad."','".$n_fija."','".$long_desc."','".$rutaFinal."','".$rutaFinal2."','".$rutaFinal3."','".$fecha_actual."')";
    $conexion->exec($sql);
