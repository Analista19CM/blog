 ...
 <body class="">
                      ...
                      <div class="card">
                          <div class="card-header card-header-primary">
                            ...
                            <div class="card-body">
                              ...
                              <div class="row">
                              <div class="col-md-6">
                              <form class="form" action="./construct/insert.php" method="POST" enctype="multipart/form-data" onsubmit="return validar(this)">
  ...
  <script>
    function validar(){
      ...
      if(titulo === "" || descripcion_c === "" || keywords === "" || categoria === "" || ciudad === "" || n_fija === "" || long_desc === "" || imagen1 === "" || imagen2 === ""){
