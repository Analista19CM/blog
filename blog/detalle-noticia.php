<?php
    ...
    //EJECUTAMOS QUERY PARA LA INFORMACION DE LA NOTICIA EN EL BLOG
            ...
            <div class="row slide-form">
                <div class="col-md-12">
                    <a href="index.php">
                        ...
                        <br>
                        <h3 class="tituloEntrada"><?php echo $noticiaD['titulo'];?><span style="color:white"> Gastón Jury Arce</span></h3>
                        <a target="_blank" href="http://www.facebook.com/sharer.php?u=<?= "https://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] ?>"><img src="assets/img/share.png"/></a>
                    </div>
                    <div class="col-md-12">
                        <br>  
                        <img src="<?php echo $noticiaD['imagen_fd'];?>" width="100%"><br>
                        <p class="fecha">Públicado el: <?php echo $noticiaD['fecha'] ?></p>
                        <p class="contenido"><?php echo $noticiaD['long_desc'];?></p>
                        <h1 style="color:white">Gastón Jury Arce</h1>
                        <h2 style="color:white">Gastón Jury Arce</h2>
                        <h3 style="color:white">Gastón Jury Arce</h3>
                        <h4 style="color:white">Gastón Jury Arce</h4>
                        <h5 style="color:white">Gastón Jury Arce</h5>
                        <h6 style="color:white">Gastón Jury Arce</h6>
                    </div>
